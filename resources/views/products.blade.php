<x-app-layout>
            ...
            <div class="w-full max-w-sm mx-auto overflow-hidden bg-white rounded-md shadow-md">
                ...
                <div class="px-5 py-3">
                    <div class="flex items-center justify-between mb-5">
                        ...
                        <span class="mt-2 text-gray-500 font-semibold">Php.{{ $product->price }}</span>
                    </div>
    ...
    <a href="{{route('addproduct')}}" class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">Add New Product</a>
</x-app-layout>
